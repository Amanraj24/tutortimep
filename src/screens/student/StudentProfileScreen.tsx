...
type StudentProfileNavigationProp = StackNavigationProp<RootStackParamList, 'StudentProfile'>;
...
const StudentProfileScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleChangePassword = async () => {
    ...
    setUpdating(true);
    try {
      await ApiService.changeStudentPassword(currentPassword, newPassword);
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.infoCard, SHADOWS.small]}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoIcon}>
                <Icon name="school" size={20} color="#f093fb" />
              </View>
              <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoIcon}>
                <Icon name="call" size={20} color="#9c27b0" />
              </View>
              <View style={styles.infoContent}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>{profile.parentPhone || 'Not provided'}</Text>
              </View>
              <Icon name="create" size={18} color={COLORS.textSecondary} />
            </View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoIcon}>
                <Icon name="location" size={20} color="#00bcd4" />
              </View>
              <View style={styles.infoContent}>
